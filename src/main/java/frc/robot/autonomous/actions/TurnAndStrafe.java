 ...
 */
public class TurnAndStrafe extends Command {
     ...
     */
    public TurnAndStrafe(boolean right, double degrees) {
    ...
    protected void execute() {
        ...
        if (rightTurn) {
            /*
             * Set a tank drive movement with speed returning from getSpeed() turning right
             */
            ...
            /*
             * Set a tank drive movement with speed returning from getSpeed() turning left
             */
